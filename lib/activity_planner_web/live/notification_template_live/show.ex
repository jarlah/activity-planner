defmodule ActivityPlannerWeb.NotificationTemplateLive.Show do
  ...
  def render(assigns) do
    ...
    <.header>
      ...
      <:actions>
        <.link
          patch={~p"/notification_templates/#{@notification_template}/show/edit"}
    ...
    <.modal
      :if={@live_action == :edit}
      id="notification_template-modal"
      show
      on_cancel={JS.patch(~p"/notification_templates/#{@notification_template}")}
    >
      <.live_component
